...
var _Logger_instances, _a, _Logger_defaultOptions, _Logger_handleOnlyFirstElem, _Logger_validateArgs, _Logger_setOptions, _Logger_writeLog, _Logger_formatLogCall, _Logger_selectColour, _Logger_formatLogContent, _Logger_callStackParser;
...
class Logger {
     ...
     * @returns {LogReturn}
     */
    preLog(errorStack, args, options) {
...
_a = Logger, _Logger_instances = new WeakSet(), _Logger_handleOnlyFirstElem = function _Logger_handleOnlyFirstElem(stack) {
    ...
    const colour = __classPrivateFieldGet(this, _Logger_instances, "m", _Logger_selectColour).call(this);
    ...
    for (; logLineIndex < callStackPartsLen; logLineIndex++) {
        ...
        if (currentLinePartsLen === 3) {
            ...
            if (_a.NATIVE_ITERATORS_TYPES.includes(iterableType) &&
