...
class Logger {
  ...
  #callStackParser(callStack) {
    ...
    for (; logLineIndex < callStackPartsLen; logLineIndex++) {
      ...
      //process | process.TicksAndRejections
      if (
        currentLineParts[1] === "process" ||
        ...
        // logTitle = logTitle.slice(
        //   0,
        //   lastOccurence + currentLineParts[1].length + delimiter.length
        // );
      ...
      if (currentLinePartsLen === 3) {
        ...
        // if(currentLineParts[1] !== "async"){
        //   throw new Error("4 split must contain [1] as async")
        // }
